	...
	SubShader{
		...
		v2f vert(a2v v) {
			...
			*/
			...
			/*
			r2.xyz = cb1[1].xyz * v.v2.yyy;
			r2.xyz = cb1[0].xyz * v.v2.xxx + r2.xyz;
			r2.xyz = cb1[2].xyz * v.v2.zzz + r2.xyz;
			*/

			r2.xyz = mul(unity_ObjectToWorld, v.v2);
		...
		fixed4 frag(v2f f) : SV_Target{
			...
			//r4.xyzw = t4.Sample(s5_s, f.o1.xy).xyzw;
